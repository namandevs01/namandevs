            ...
            <RevealOnScroll>
                <div className="max-w-5xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-1 gap-6">
                        <div className="mb-8 border-white/10 border rounded-xl p-6 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
                            <h3 className="text-xl font-bold mb-2 ">
                                Portfolio Website
                            </h3>
                            <p className="text-gray-400 mb-4">
                                Stunning Website with EmailJS Functionality to showcase my Work.
                            </p>
